...
public class MemberDefault  implements DataSetRowTypeAccessor {
  ...
  public void setPaging(){
	...
	public String toString() {
		return "MemberDefault [search_userId=" + search_userId
				...
				+ searchKeyword + ", searchUseYn=" + searchUseYn + ", rowType="
				+ rowType + ", page=" + page + ", totalPage=" + totalPage
				+ ", viewListCount=" + viewListCount + ", viewPageNum="
				+ viewPageNum + ", startPage=" + startPage + ", endPage="
				+ endPage + ", totalList=" + totalList + ", startList="
